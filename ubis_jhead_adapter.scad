...
module jheadtoubis(pushfit=false,bracket=true,nuttrap=true, bowden=true, reverse=false,solid=false) {
difference() {
...
jheadtoubis(pushfit=true,bracket=true,nuttrap=false,bowden=true,reverse=false,solid=false);
